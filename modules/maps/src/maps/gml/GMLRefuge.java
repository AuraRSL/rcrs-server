...
public class GMLRefuge extends GMLBuilding{
    ...
    /**
     Construct a GMLRefuge.
     @param id The ID of the Refuge.
     @param edges The edges of the Refuge.
     */
    ...
    /**
     ...
     @param newCapacity The new bed capacity of the Refuge.
     */
    ...
    /**
     ...
     @param newCapacity The new refill capacity of the Refuge.
     */
